                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                        ...
                        <address>
                            ...
                            HONG KONG<br />
                            <i className="fa fa-phone"></i> +852 8654321<br/>
                            <i className="fa fa-fax"></i>: +852 8765 4321<br />
                            <i className="fa fa-envelope"></i>: <a href="mailto:lokeshdulani91@gmail.com">confusion@food.net</a>
                        </address>
                    </div>
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    value={this.state.telnum} onChange={this.handleInputChange} onBlur={this.handleBlur('tenum')}/>
